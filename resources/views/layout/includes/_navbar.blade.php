<nav class="navbar navbar-default navbar-fixed-top">
    <div class="brand">
        <a href="index.html"><img src="{{asset('logo-tm.png')}}" alt="Klorofil Logo" class="img-responsive logo"></a>
    </div>
    <div class="container-fluid">
        ...
        <div class="navbar-btn navbar-btn-right">
            <a class="btn btn-success update-pro"
                href="https://trustmedis.com/harga/"
                title="Upgrade HIS Anda" target="_blank"><i class="fa fa-rocket"></i> <span>Upgrade HIS Anda</span></a>
        </div>
        <div id="navbar-menu">
            <ul class="nav navbar-nav navbar-right">
                ...
                <!-- <li>
                    <a class="update-pro" href="https://www.themeineed.com/downloads/klorofil-pro-bootstrap-admin-dashboard-template/?utm_source=klorofil&utm_medium=template&utm_campaign=KlorofilPro" title="My Profil" target="_blank"><i class="fa fa-user"></i> <span>My Profil</span></a>
                </li> -->
            </ul>
        </div>
    </div>
